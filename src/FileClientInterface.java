...
public interface FileClientInterface {
    ...
    /**
     * Connect to the specified file server. No other methods should work until
     * the client is connected to a file server.
     *
    ...
    /**
     * Downloads a file from the server. The user must be a member of the group
     * with which this file is shared.
     *
    ...
    /**
     * Deletes a file from the server. The user must be a member of the group
     * with which this file is shared.
     *
